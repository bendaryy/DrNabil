                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-2" style="margin-top: 23">
                                ...
                                <a href="{{ route('customers.create') }}" class="btn btn btn-success " style="text-align: center;min-width: 250px!important; background-color: #1598ca;
                                                    border-color: #1598ca;">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" name="receiverCountry"
                                            placeholder="@lang('site.Country')" value="{{ $com->country!=null?$com->country:'EG' }}">
                                    </div>
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" name="receiverGovernate"
                                            placeholder="@lang('site.Governorate')" value="{{ $com->governate!=null?$com->governate:'-' }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" name="receiverRegionCity"
                                            placeholder="@lang('site.City')" value="{{ $com->regionCity!=null?$com->regionCity:'-' }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" name="receiverBuildingNumber"
                                            ...
                                            value="{{ $com->buildingNumber!=null?$com->buildingNumber:'-' }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" name="receiverPostalCode"
                                            placeholder="@lang('site.PostalCode') " value="{{ $com->postalCode!=null?$com->postalCode:'' }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control  text-center" name="receiverRoom"
                                            placeholder="@lang('site.FlatNo')" value="{{ $com->room!=null?$com->room:'' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control  text-center" name="receiverLandmark"
                                            placeholder="@lang('site.landmark')" value="{{ $com->landmark!=null?$com->landmark:'' }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control  text-center"
                                            ...
                                            value="{{ $com->additionalInformation!=null?$com->additionalInformation:'' }}">
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="row">
                                            ...
                                            <div class="accordion-body" id="newOne">
                                                ...
                                                <div class="border border-3 p-4 rounded">
                                                    ...
                                                    <div class=" row g-3">
                                                        <div class="col-md-6">
                                                            <label for="inputProductTitle"
                                                                class="form-label"> الضريبة الجدول (النسبية)</label>
                            ...
                            <div class="col-lg-4" style="margin-top: -120px">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label for="findTotalt2Amount" class="form-label">إجمالى الجدول (النسبية)
                                                </label>
