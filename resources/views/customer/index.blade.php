...
@section('content')
			...
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							<a href="{{ route('customers.create') }}" class="btn btn-outline-success px-5 radius-30">
                                    ...
                                    <tr>
										...
										<td>{{ $customer->tax_id }}</td>
 										...
 										<td>
                                            ...
                                            <form style="display: contents;" method="post" action="{{ route('customers.destroy', $customer->id ) }}">
                                            ...
                                            <a href="{{ route('customers.edit', $customer->id ) }}" class="btn btn-outline-primary"><i class="bx bxs-edit me-0"></i></a>
