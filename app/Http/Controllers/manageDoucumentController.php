...
// this is for receiver address
        ...
        $myFileToJson = fopen("C:\laragon\www\DrNabil\EInvoicing\SourceDocumentJson.json", "w") or die("unable to open file");
...
// this function for signature
    ...
    public function openBat()
    {
        ...
        shell_exec('C:\laragon\www\DrNabil\EInvoicing/SubmitInvoices2.bat');
        $path = "C:\laragon\www\DrNabil\EInvoicing/FullSignedDocument.json";
        $path2 = "C:\laragon\www\DrNabil\EInvoicing/Cades.txt";
        $path3 = "C:\laragon\www\DrNabil\EInvoicing/CanonicalString.txt";
        $path4 = "C:\laragon\www\DrNabil\EInvoicing/SourceDocumentJson.json";
...
// this is for create page of invoice
    ...
    public function createInvoice2(Request $request)
    {
        ...
        $codes = DB::table('products')->where('status', 'Approved')->get();
        $ActivityCodes = DB::table('activity_code')->get();
        $allCompanies = DB::connection('mysql')->table('companies2')->get();
        $taxTypes = DB::table('taxtypes')->get();
        $companiess = DB::connection('mysql')->table('companies2')->where('id', $request->receiverName)->get();
